...
def reduce_sample_rate(audio_data: np.ndarray, sample_rate: int, new_sample_rate: int) -> tuple[np.ndarray, int]:
    """
    ...
    return compressed, new_sample_rate
...
compressed_full, compressed_sample_rate_full = reduce_sample_rate(stereo_to_mono(audio_data_full), sample_rate_full, 4400)
compressed_partial, compressed_sample_rate_partial = reduce_sample_rate(stereo_to_mono(audio_data_partial), sample_rate_partial, 4400)
